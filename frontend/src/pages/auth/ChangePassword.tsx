...
function ChangePassword() {
  ...
  return (
    <main className="min-h-screen bg-[var(--bg-secondary)] px-6 py-10 text-[var(--text-primary)]">
      {showToast ? (
        <div className="fixed right-6 top-6 rounded-md border border-[var(--border-color)] bg-[var(--surface)] px-4 py-3 text-sm font-semibold text-[#185FA5] shadow-sm">
          Password changed successfully.
        </div>
      ) : null}

      <section className="mx-auto max-w-xl rounded-lg border border-[var(--border-color)] bg-[var(--card-bg)] p-6 shadow-sm">
