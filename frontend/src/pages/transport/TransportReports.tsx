...
import { useTransportReports } from '../../hooks/useTransport';
...
function TransportReports() {
  ...
  const generateReport = async () => {
    ...
    window.open(`/api/transport/reports/${reportType}?${new URLSearchParams(params as Record<string, string>).toString()}`, '_blank');
  };
