import { useTransportAnnouncements } from '../../hooks/useTransport';

function Announcements() {
  const { data: announcements = [], isLoading } = useTransportAnnouncements();

  return (
    <div className="space-y-6">
      <div className="rounded-[26px] border border-[#EFF2F6] bg-white p-6 shadow-sm">
        <h2 className="text-lg font-semibold text-slate-950">Transport Announcements</h2>
            ...
            <div className="rounded-[16px] border border-[#EFF2F6] bg-[#F8FAFC] p-4" key={announcement.id}>
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="mt-1 font-semibold text-slate-950">{announcement.title || 'Transport Announcement'}</p>
